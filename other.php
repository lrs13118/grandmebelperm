...
<head>
	...
	<title>Другое | <?php echo $config['title']; ?></title>
...
<body>
	...
	<main>
		...
		<div class="other_blocks_container">
				<?php
					$product = mysqli_query ($connection, "SELECT * FROM products WHERE categories = 6 ORDER BY id DESC");
